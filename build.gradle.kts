...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name.set("circuit-breaker")
                description.set("Coroutine-aware circuit breaker for resilient Kotlin services")
                url.set("https://github.com/philiprehberger/kt-circuit-breaker")
                ...
                scm { url.set("https://github.com/philiprehberger/kt-circuit-breaker"); connection.set("scm:git:git://github.com/philiprehberger/kt-circuit-breaker.git"); developerConnection.set("scm:git:ssh://github.com/philiprehberger/kt-circuit-breaker.git") }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/philiprehberger/kt-circuit-breaker/issues")
                }
            }
        }
    }
